...
class Utils {
     ...
     */
    public static function convertDateToFrenchFormat(DateTimeInterface $date) : string
    {
    ...
    public static function redirect(string $action, array $params = []) : void
    {
     ...
     /**
     * Retourne une durée lisible depuis une date donnée.
     * Exemples : "3 ans" | "2 mois" | "14 jours" | "aujourd’hui" | "date inconnue"
     */
    public static function formatSince(?\DateTimeInterface $start): string
    {
        if (!$start) {
