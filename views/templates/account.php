<div class="container-fluid justify-content-center d-flex h-100" style="background-color:#FAF9F7">    
    ...
    <div class="row col-10 mt-4 d-flex justify-content-evenly">
        <section class="col-3 p-4 mb-4 justify-content-center flex-wrap p-5  rounded-1 " style="background-color:#FFFFFF">
        ...
        <section style="background-color:#FFFFFF"class="p-3 col-8 mb-3">
